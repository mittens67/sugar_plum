...
const CustomForm = ({customClass}) => {
  return (
    <div className={`bg-sugarplum-sp_red_pink text-white p-[2%] ${customClass}`}>
      <h2 className="font-black text-lg sm:text-xl md:text-2xl">Looking For Something Specially Custom Made?</h2>
      <p className="text-base sm:text-lg md:text-xl">Let Us Know Below!</p>
